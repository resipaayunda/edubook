...
<style>
    /* Card Dasar & Container */
    .custom-card {
        border-radius: 15px;
        border: none;
    }
    
    /* Stats Card - Diperbaiki Alignment & Padding */
    .stat-card-colored {
        border-radius: 16px;
        border: none;
        color: white;
    ...
    /* Memastikan konten di dalam card center secara vertikal */
    .stat-card-body {
        padding: 1.5rem;
        display: flex;
    ...
    .stat-number-small {
        font-size: 1.8rem; /* Ukuran lebih proporsional */
        font-weight: 800;
        margin-bottom: 2px;
        line-height: 1.2;
    }
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Ringkasan data aktivitas perpustakaan.</p>
        </div>
        <a href="{{ route('admin.laporan.pdf', request()->all()) }}" class="btn btn-danger px-4 fw-bold shadow-sm" style="border-radius: 10px;">
            <i class="fas fa-file-pdf me-2"></i>Cetak PDF
        </a>
    </div>

    {{-- STATISTIK CARDS - DIBUAT LEBIH RAPI --}}
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="card stat-card-colored bg-gradient-purple shadow-sm">
                <div class="stat-card-body">
                    <div>
                        <div class="stat-label-small">Total Data</div>
                        <div class="stat-number-small">{{ $laporans->count() }}</div>
                        <div class="small opacity-75">Transaksi Teratat</div>
                    </div>
            ...
            <div class="card stat-card-colored bg-gradient-blue shadow-sm">
                <div class="stat-card-body">
                    <div>
                        ...
                        <div class="small opacity-75">Buku Dikembalikan</div>
                    </div>
                    <div class="icon-box-white">
            ...
            <div class="card stat-card-colored bg-gradient-orange shadow-sm">
                <div class="stat-card-body">
                    <div>
                        ...
                        <div class="stat-number-small">{{ $laporans->where('status', '!=', 'kembali')->count() }}</div>
                        <div class="small opacity-75">Aktif Dipinjam</div>
                    </div>
                    <div class="icon-box-white">
            ...
            <form method="GET" action="{{ route('admin.laporan.index') }}">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.laporan.index') }}" class="btn btn-outline-secondary rounded-3">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td class="text-start fw-bold">{{ $l->user->name ?? 'Guest' }}</td>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="py-5 text-center text-muted small">Data tidak ditemukan.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
